# HeadQtrs — The Athletics Command Center
...
and branding are configurable per organization. The sidebar carries the school's own
name and logo — HeadQtrs is the platform underneath.
...
| **Events** | 115 real events from the Fall 2026 composite schedule; searchable list; create/edit with validation; opponent picker with primary logos; region/area game tagging; CSV schedule import for mass-adding games |
...
| **Teams** | Workspaces with overall + region/area records, postseason finish, schedule, results, coaching staff, broadcasts, open requests, missing-info flags, completeness score |
| **Assets** | Folder-organized library (Opponent Logos, Sponsor Logos, Team Photos by team, …) with global search, download, mock upload + approval flow, and primary-logo assignment for opponents |
...
- **Sample results.** Scores on past dates are demo-generated. Settings → Prototype
  controls can hide them to preview the true preseason state; scores you enter yourself
  always stay visible.
